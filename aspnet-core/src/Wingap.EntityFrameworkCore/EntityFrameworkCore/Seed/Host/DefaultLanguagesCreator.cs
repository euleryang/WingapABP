...
namespace Wingap.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly WingapDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = WingapConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(WingapDbContext context)
        {
            _context = context;
        }
