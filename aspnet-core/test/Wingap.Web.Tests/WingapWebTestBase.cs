...
{
    public abstract class WingapWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WingapWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WingapWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WingapDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WingapDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WingapDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WingapDbContext, Task<T>> func)
        {
            T result;
